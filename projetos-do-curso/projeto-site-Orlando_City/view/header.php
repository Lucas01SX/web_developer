...
<head>
    ...
    <link rel="stylesheet" href="../assets/raty/lib/jquery.raty.css">
...
<body>
    <header>
        ...
        <div class="container">
            <img id="logotipo" src="../assets/images/orlando-logo.png" alt="Logo do clube Orlando City">
        </div>
                        ...
                        <li class="search">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <button id="pesquisa" class="" type="button"><i class="fa fa-search"></i></button>
                                </span>
                            </div>
                        </li>
                    </ul>
